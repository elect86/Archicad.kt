...
class DeleteAttributes {
    ...
    @Test
    fun run() {
        val executionResults = Archicad.deleteAttributes(AttributeId("7d30d4fc-4c93-4ffa-82c8-aa17b32da2b9".uuid),
        ...
        assert(executionResults()[2].error == Result.Error(6102, "Attribute not found by guid (GUID: D4CAD19B-C68F-4534-BD7D-11C962DF638A)"))
    }
}