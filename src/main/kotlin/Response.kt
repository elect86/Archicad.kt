...
internal constructor(@PublishedApi
     ...
     */
    //    public fun exceptionOrNull(): Throwable? = when (value) {
...
/**
 * Creates an instance of internal marker [Result.Error] class to
...
//    if (value is Result.Error) throw value.exception
//}
 ...
 * result of [onFailure] function for the encapsulated [Throwable] exception if it is [failure][Result.isError].
 *
 ...
 * or the result of [onFailure] function for the encapsulated [Throwable] exception if it is [failure][Result.isError].
 *
 ...
 * if this instance represents [failure][Result.isError] or the
...
/**
 * Performs the given [action] on the encapsulated [Throwable] exception if this instance represents [failure][Result.isError].
